...
const btnrumrene = document.getElementById("rene");
btnrumrene.addEventListener("click", rene);
function rene() {
  Swal.fire({
...
function Kaikoura() {
  Swal.fire({
    title: '<span style="font-size: 25px;"><u>Difusor Kaikoura</u></span>',
    html: ' <div style="text-align: left;"> <span style="font-size: 15px;">Envase pet con tapa difusora y varillas de rattan negras.<br> Capacidad: 250ml.<br><br><b>Disponible en los siguientes blends:</b><br>▪️ Sydney<br>▪️ Nega<br>▪️ Sandía Frambuesa<br>▪️ Bambú<br>▪️ Fresh Grass<br></span></div>'})   
}
