...
function blanca() {
  Swal.fire({
    ...
    html: '<div style="text-align: left;"> <span style="font-size: 15px;">Vela de soja.<br> Vela de soja. Envase vidrio con tapa de madera. <br> <b>Dimensiones:</b> 8 cm. de diámetro x 8.5 cm. de alto.<br><b>Capacidad:</b> 315cc.<br><b>Aroma:</b> <br>Vainilla Especiada<br>Pera Pepino Manzana<br>Sandia Frambuesa</span></div>'})   
}
